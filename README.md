...
FamMes - мобильное iOS-приложение, которое объединяет мессенджер и систему личных и общих заметок. Пользователь может общаться с другими участниками, создавать личные записи, вести общие заметки с выбранными людьми и хранить важные договоренности рядом с перепиской.
...
Скриншоты должны лежать в папке `docs/screenshots` в корне репозитория. Тогда GitHub корректно отобразит их в README.
...
| Переписка | Заметки | Общая заметка |
| --- | --- | --- |
...
- OpenAI Codex - анализ структуры проекта и подготовка README.
